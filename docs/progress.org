...
** TODO console improvements
   ...
   - navigation support, tab/enter control
   - resizing.
   - better drawing.
   - loading also the icons(since you had icon caches).
   - configuration and plugins. Yes, of course you need plugins.
