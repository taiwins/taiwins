...
* TODO [14%] Stage two: feature completion
  ...
  - resize EGL windows.
  - compositing
** TODO [83%] server-side optimization
...
*** DOIN [#B] passing server events to shell, switch workspace. e.g.
    ...
    - keybindings activated, this is a bit hard, you need to add callbacks in
      the binding system.
    - I seriously can remember another
...
**** DONE panel pos
**** TODO init wallpaper
**** TODO init widget [[nuklear luabinding]]
**** TODO set menus
