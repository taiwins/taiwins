...
**** TODO get outputs, outputs are different than heads, be able to control output creation process.
...
** DOIN [33%] launcher implementation
...
* TODO [0%]Stage three: extensions
** TODO [18%] Tasks didn't finish in stage 2
*** TODO backend configuration
