...
** [50%] libweston-desktop implementation                            :server:
...
*** TODO renaming launcher into commander, since it will does much more than just launching
