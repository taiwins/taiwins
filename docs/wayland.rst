...
- it need to build up the ``view_list`` of current frame, extract from layers,
...
- next it accumenate the damage, when you set ``weston_view_damage_ below``\ ,
...
.. _blog: http://ppaalanen.blogspot.com/2014/07/wayland-protocol-design-object-lifespan.html
