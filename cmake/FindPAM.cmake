...
get_filename_component(PAM_LIBDIR ${PAM_LIBRARY} PATH)
get_filename_component(DL_LIBDIR ${DL_LIBRARY} PATH)
...
if (PAM_FOUND AND NOT TARGET PAM::PAM)
  ...
  set_target_properties(PAM::PAM PROPERTIES
    ...
    INTERFACE_LINK_DIRECTORIES "${PAM_LIBDIR}" "${DL_LIBDIR}"
    INTERFACE_LINK_LIBRARIES pam;dl
